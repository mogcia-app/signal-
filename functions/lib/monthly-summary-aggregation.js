...
exports.addContributionToPatch = exports.createPatch = exports.applyDeltaNonNegative = exports.negateContribution = exports.buildContribution = exports.toDayString = exports.toMonthString = exports.toDate = exports.toNumber = void 0;
const EMPTY_DELTA = {
    likes: 0,
    comments: 0,
    shares: 0,
...
function negateContribution(input) {
    return Object.assign(Object.assign({}, input), { delta: {
...
function createPatch(userId, month, docId) {
    return {
        ...
        delta: Object.assign({}, EMPTY_DELTA),
        dailyByDate: new Map(),
    };
}
