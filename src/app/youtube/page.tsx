      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-lg shadow-sm border border-gray-200">
              <div className="px-6 py-4 border-b border-gray-200">
                <h2 className="text-lg font-semibold text-black">YouTube AI設定</h2>
                <p className="text-sm text-black">自動投稿・サムネイル・SEO最適化設定</p>
              </div>
              <div className="p-6">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200">
              <div className="px-6 py-4 border-b border-gray-200">
                <h3 className="text-lg font-semibold text-black">チャンネル統計</h3>
              </div>
              <div className="p-6 space-y-4">
                <div className="flex justify-between">
                  <span className="text-sm text-black">登録者数</span>
                  <span className="text-sm font-medium text-black">-</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-sm text-black">総再生回数</span>
                  <span className="text-sm font-medium text-black">-</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-sm text-black">公開動画数</span>
                  <span className="text-sm font-medium text-black">-</span>
                </div>
              </div>
            </div>
