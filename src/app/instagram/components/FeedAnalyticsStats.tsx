...
import { BarChart3, Heart, MessageCircle, Share, Eye, Save, UserPlus, Users, TrendingUp, Target } from 'lucide-react';
...
const FeedAnalyticsStats: React.FC<FeedAnalyticsStatsProps> = ({
  ...
  const totalFollowerIncrease = feedData.reduce((sum, data) => sum + (Number(data.followerIncrease) || 0), 0);
  
  // 概要データ
  const totalInteractionCount = feedData.reduce((sum, data) => sum + (Number(data.interactionCount) || 0), 0);
  const avgReachFollowerPercent = feedData.length > 0 
    ? feedData.reduce((sum, data) => sum + (Number(data.reachFollowerPercent) || 0), 0) / feedData.length 
    : 0;
  const avgInteractionFollowerPercent = feedData.length > 0 
    ? feedData.reduce((sum, data) => sum + (Number(data.interactionFollowerPercent) || 0), 0) / feedData.length 
    : 0;
  
  // 閲覧上位ソース
  const totalReachSourceProfile = feedData.reduce((sum, data) => sum + (Number(data.reachSourceProfile) || 0), 0);
  const totalReachSourceFeed = feedData.reduce((sum, data) => sum + (Number(data.reachSourceFeed) || 0), 0);
  const totalReachSourceExplore = feedData.reduce((sum, data) => sum + (Number(data.reachSourceExplore) || 0), 0);
  const totalReachSourceSearch = feedData.reduce((sum, data) => sum + (Number(data.reachSourceSearch) || 0), 0);
  const totalReachSourceOther = feedData.reduce((sum, data) => sum + (Number(data.reachSourceOther) || 0), 0);
  
  // リーチしたアカウント
  const totalReachedAccounts = feedData.reduce((sum, data) => sum + (Number(data.reachedAccounts) || 0), 0);
  
  // プロフィールのアクティビティ
  const totalProfileVisits = feedData.reduce((sum, data) => sum + (Number(data.profileVisits) || 0), 0);
    ...
    <div className="bg-white shadow-sm border border-gray-200 p-6">
      ...
      <div className="mb-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <div className="bg-white border border-gray-200 p-4">
            <div className="flex items-center justify-between">
              <div>
                <div className="text-2xl font-bold text-gray-800">{totalFollowerIncrease.toLocaleString()}</div>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="bg-white border border-gray-200 p-4">
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-2xl font-bold text-gray-800">{totalInteractionCount.toLocaleString()}</div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="bg-white border border-gray-200 p-4">
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-2xl font-bold text-gray-800">{avgReachFollowerPercent.toFixed(1)}%</div>
            ...
            <div className="bg-white border border-gray-200 p-4">
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-2xl font-bold text-gray-800">{avgInteractionFollowerPercent.toFixed(1)}%</div>
      ...
      <div className="mb-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          <div className="bg-white border border-gray-200 p-4">
            <div className="flex items-center justify-between">
              <div>
                <div className="text-2xl font-bold text-gray-800">{totalReachSourceProfile.toLocaleString()}</div>
          ...
          <div className="bg-white border border-gray-200 p-4">
            <div className="flex items-center justify-between">
              <div>
                <div className="text-2xl font-bold text-gray-800">{totalReachSourceFeed.toLocaleString()}</div>
          ...
          <div className="bg-white border border-gray-200 p-4">
            <div className="flex items-center justify-between">
              <div>
                <div className="text-2xl font-bold text-gray-800">{totalReachSourceExplore.toLocaleString()}</div>
          ...
          <div className="bg-white border border-gray-200 p-4">
            <div className="flex items-center justify-between">
              <div>
                <div className="text-2xl font-bold text-gray-800">{totalReachSourceSearch.toLocaleString()}</div>
          ...
          <div className="bg-white border border-gray-200 p-4">
            <div className="flex items-center justify-between">
              <div>
                <div className="text-2xl font-bold text-gray-800">{totalReachSourceOther.toLocaleString()}</div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="bg-white border border-gray-200 p-4">
          <div className="flex items-center justify-between">
            <div>
              <div className="text-2xl font-bold text-gray-800">{totalReachedAccounts.toLocaleString()}</div>
        ...
        <div className="bg-white border border-gray-200 p-4">
          <div className="flex items-center justify-between">
            <div>
              <div className="text-2xl font-bold text-gray-800">{totalProfileVisits.toLocaleString()}</div>
