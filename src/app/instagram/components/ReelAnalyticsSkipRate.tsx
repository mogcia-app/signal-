...
interface ReelAnalyticsSkipRateProps {
  data: InputData;
  onInputChange: (field: keyof InputData, value: string) => void;
}

export const ReelAnalyticsSkipRate: React.FC<ReelAnalyticsSkipRateProps> = ({
  data,
  onInputChange,
}) => {
  return (
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          ...
          <input
            ...
            onChange={(e) => onInputChange("reelSkipRate", e.target.value)}
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) => onInputChange("reelNormalSkipRate", e.target.value)}
            className="w-full px-3 py-2 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#ff8a15] focus:border-[#ff8a15] [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
            placeholder="0"
          />
        </div>
