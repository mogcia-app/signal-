      ...
      <details className="group">
        <summary className="flex items-center justify-between px-5 py-4 text-left cursor-pointer select-none">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 bg-slate-900/80 flex items-center justify-center">
        ...
        <div className="px-5 pb-5 space-y-4">
          {presets.map((preset) => (
            <div
              key={preset.id}
              className="border border-slate-200 p-4 bg-slate-50/70 space-y-3"
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                {preset.variants.map((variant) => (
                  <div key={variant.label} className="bg-white border border-slate-200 p-3">
