...
export default function TermsPage() {
  ...
  const sections = [
    ...
    { id: 'subscription', label: 'サブスクリプション', icon: <CreditCard className="w-4 h-4" /> },
    { id: 'payment', label: '支払い条件', icon: <Calendar className="w-4 h-4" /> },
    { id: 'cancellation', label: '解約・返金', icon: <AlertTriangle className="w-4 h-4" /> },
    { id: 'disclaimer', label: '免責事項', icon: <Shield className="w-4 h-4" /> },
    { id: 'privacy', label: 'プライバシー', icon: <Users className="w-4 h-4" /> },
    { id: 'contact', label: 'お問い合わせ', icon: <Phone className="w-4 h-4" /> }
  ];
          ...
          <div className="flex-1">
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
              ...
              {activeSection === 'overview' && (
                <div>
                  <h2 className="text-2xl font-bold text-gray-900 mb-6">利用規約の概要</h2>
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-gray-900 mb-3">サービスについて</h3>
                      <p className="text-gray-700 mb-4">
                        Signal（以下「本サービス」）は、Instagram、Twitter、YouTube、TikTokなどのSNSプラットフォームでの
                        マーケティング活動を支援するツールです。
                      </p>
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-gray-900 mb-3">適用範囲</h3>
              ...
              {activeSection === 'subscription' && (
                <div>
                  <h2 className="text-2xl font-bold text-gray-900 mb-6">サブスクリプション</h2>
                  ...
                  <div className="space-y-6">
                    <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
                      ...
                      <ul className="text-yellow-800 space-y-2">
                        ...
                        <li>• 途中解約の場合は、残り期間分の料金をお支払いいただきます</li>
                        <li>• 解約手続き後も、契約期間終了までサービスをご利用いただけます</li>
                      </ul>
                    </div>

                    <div>
                      <h3 className="text-lg font-semibold text-gray-900 mb-3">料金プラン</h3>
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-gray-900 mb-3">自動更新</h3>
                      <p className="text-gray-700">
              ...
              {activeSection === 'payment' && (
                <div>
                  <h2 className="text-2xl font-bold text-gray-900 mb-6">支払い条件</h2>
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-gray-900 mb-3">支払い方法</h3>
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-gray-900 mb-3">料金の変更</h3>
                      <p className="text-gray-700">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-gray-900 mb-3">税務処理</h3>
                  <p className="text-gray-700">
              ...
              {activeSection === 'cancellation' && (
                <div>
                  <h2 className="text-2xl font-bold text-gray-900 mb-6">解約・返金</h2>
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-gray-900 mb-3">解約手続き</h3>
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-gray-900 mb-3">返金ポリシー</h3>
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-gray-900 mb-3">データの保持</h3>
                      <p className="text-gray-700">
                        解約後、お客様のデータは30日間保持されます。この期間中に再契約いただければ、
                        データは復元されます。30日経過後、データは完全に削除されます。
                      </p>
                    </div>
                  </div>
                </div>
              ...
              {activeSection === 'disclaimer' && (
                <div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-gray-900 mb-3">サービス利用に関する免責</h3>
                      <ul className="text-gray-700 space-y-2">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-gray-900 mb-3">技術的制限</h3>
                      <ul className="text-gray-700 space-y-2">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-gray-900 mb-3">著作権・知的財産権</h3>
                      <p className="text-gray-700">
              ...
              {activeSection === 'privacy' && (
                <div>
                  <h2 className="text-2xl font-bold text-gray-900 mb-6">プライバシー・データ保護</h2>
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-gray-900 mb-3">データの利用目的</h3>
                      <ul className="text-gray-700 space-y-2">
                        <li>• サービスの提供・改善</li>
                        <li>• お客様サポート</li>
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-gray-900 mb-3">データの保存期間</h3>
                      <p className="text-gray-700">
              ...
              {activeSection === 'contact' && (
                <div>
                  ...
                  <div className="space-y-6">
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
                      <h3 className="text-lg font-semibold text-blue-900 mb-3">サポートセンター</h3>
                    ...
                    <div>
                      ...
                      <div className="space-y-3">
                        <div className="border border-gray-200 rounded-lg p-4">
                          <h4 className="font-medium text-gray-900">解約手続きはどうすればよいですか？</h4>
                          <p className="text-sm text-gray-600 mt-1">
                            マイアカウントページの「サブスクリプション管理」から解約手続きを行ってください。
                          </p>
                        </div>
                        <div className="border border-gray-200 rounded-lg p-4">
                          <h4 className="font-medium text-gray-900">料金の支払い方法を変更できますか？</h4>
                          <p className="text-sm text-gray-600 mt-1">
                            はい、マイアカウントページの「支払い方法」から変更できます。
                          </p>
                        </div>
                        <div className="border border-gray-200 rounded-lg p-4">
                          <h4 className="font-medium text-gray-900">データは安全に保管されますか？</h4>
                          <p className="text-sm text-gray-600 mt-1">
                            はい、業界標準のセキュリティ対策により、データを安全に保管しています。
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-gray-50 border border-gray-200 rounded-lg p-6">
                      <h3 className="text-lg font-semibold text-gray-900 mb-3">法的情報</h3>
