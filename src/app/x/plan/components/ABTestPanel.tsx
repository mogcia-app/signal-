    ...
    return (
      <div className="bg-white rounded-lg shadow-sm border border-gray-200">
        <div className="px-6 py-4 border-b border-gray-200">
          <h3 className="text-lg font-semibold text-gray-900">A/Bテスト</h3>
        </div>
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200">
        <div className="px-6 py-4 border-b border-gray-200">
          ...
          <p className="text-sm text-gray-600">過去のテスト結果と推奨事項</p>
        </div>
        <div className="p-6">
          <div className="space-y-6">
              ...
              <div key={index} className="border border-gray-200 rounded-lg p-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                  <div className={`p-3 rounded-lg ${
                    ...
                    <div className="font-medium text-gray-900 mb-1">バリアントA</div>
                    <div className="text-sm text-gray-600 mb-1">{test.variantA.name}</div>
                  ...
                  <div className={`p-3 rounded-lg ${
                    ...
                    <div className="font-medium text-gray-900 mb-1">バリアントB</div>
                    <div className="text-sm text-gray-600 mb-1">{test.variantB.name}</div>
                    <div className="text-lg font-semibold text-gray-900">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200">
        <div className="px-6 py-4 border-b border-gray-200">
          <h3 className="text-lg font-semibold text-gray-900">新しいテスト提案</h3>
        </div>
        <div className="p-6">
