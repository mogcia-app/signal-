...
import { SimulationRequest, ABTestScenario, ABTestComparison } from '../../../instagram/plan/types/plan';
...
// シナリオ比較
function compareScenarios(scenarios: ABTestScenario[], userProfile: SimulationRequest): ABTestComparison {
  // 各シナリオのスコア計算
