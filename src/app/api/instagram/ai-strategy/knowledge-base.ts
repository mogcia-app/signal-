...
export const instagramKnowledge: KnowledgeEntry[] = [
  {
    ...
    category: "投稿戦略",
    content:
      "フォロワー1000人未満：週3-4回のフィード投稿、週2-3回のリール投稿が最適。エンゲージメント率を重視。",
  ...
  },
  {
    ...
    category: "投稿戦略",
    content:
      "フォロワー1000-10000人：週2-3回のフィード投稿、週3-4回のリール投稿。ブランド一貫性を重視。",
  ...
  },
  {
    ...
    category: "投稿戦略",
    content:
      "フォロワー10000人以上：週1-2回のフィード投稿、週2-3回のリール投稿。品質重視、広告連携。",
  ...
  },
  {
    ...
    category: "コンテンツ戦略",
    content:
      "認知段階：ブランド世界観、価値提案。興味段階：ノウハウ、実績紹介。検討段階：商品詳細、比較。",
  ...
  },
  {
    ...
    category: "投稿タイミング",
    content:
      "平日19-21時、休日10-12時、15-17時がエンゲージメント率が高い。ターゲット層に合わせて調整。",
  ...
  },
  {
    ...
    category: "ハッシュタグ戦略",
    content:
      "ビッグワード（100万以上）3-5個、ミドルワード（1-100万）5-8個、スモールワード（1万以下）5-7個。",
...
export function getLearningInsights(userId: string): string {
  ...
  // よく使われる戦略
  const allStrategies = recentAnalyses.flatMap(
    (a) => (a.formData.strategyValues as string[]) || []
  );
  const strategyCounts = allStrategies.reduce(
    (acc, strategy) => {
  ...
  const topStrategy = Object.entries(strategyCounts).sort(([, a], [, b]) => b - a)[0]?.[0];
