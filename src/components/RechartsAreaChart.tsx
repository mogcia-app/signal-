...
const RechartsAreaChart: React.FC<RechartsAreaChartProps> = ({ data, title, subtitle }) => {
    ...
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
      ...
      <div className="mt-6 flex items-center justify-between">
        ...
        <div className="text-xs text-black space-x-4">
          <span>
            最高: <span className="font-medium text-orange-600">{maxScore}点</span>
          </span>
          <span>
            最低: <span className="font-medium text-orange-600">{minScore}点</span>
          </span>
          <span>
            平均: <span className="font-medium text-orange-600">{avgScore}点</span>
          </span>
        </div>
      </div>
    </div>
